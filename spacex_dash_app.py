...
import pandas as pd
import dash
from dash import html #dash_html_components as html
from dash import dcc #dash_core_components as dcc
...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                # Line break in the launched application 
                                html.Br(),
                                ...
                                # Interval between each selectable value
                                step=1000,
                                # Labelled values on the slider
...
def get_pie_chart(entered_site):
    if entered_site=='ALL':
        ...
        grouped_df=filtered_df.groupby('Launch Site').size().reset_index(name='count')
        fig=px.pie(grouped_df,values='count',names='Launch Site',
...
def get_scatter_chart(entered_site,payload_range):
    if entered_site=='ALL':
        ...
        labels=dict(x='Payload Mass (kg)',y='class'),
        ...
        color='Booster Version Category',
        labels=dict(x='Payload Mass (kg)',y='class'),
        title='Correlation between Payload and Launch Success for '+str(entered_site)
        )
        return fig
# Run the app
